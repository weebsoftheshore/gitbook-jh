...
Judges should speak confidently when attending a call or speaking to a player. Even when a judge is unsure of the right answer, it is still possible to communicate this clearly and confidently while seeking another judge's opinion. Relatedly, decisive language may help convey confidence. For example, rather than beginning to answer a question regarding an interaction with "I think," simply answer the question. It is more helpful to add that you would like to verify an interpretation with another judge than to lead with an indecisive and unconfident "I think."
